    ...
    if (usuarioLogado === "true") {
        ...
        if (cargoUsuario === "admin") {
            ...
            linksDinamicosHTML = `
                ...
                <a href="${prefixoUrl}ticket/ticket.html" class="item-menu-lat"><i class="fa-solid fa-folder-open"></i> Visualizar Tickets</a>
                <a href="${prefixoUrl}Estoque/estoque.html" class="item-menu-lat"><i class="fa-solid fa-car"></i> Ver Estoque</a>
            `;
        } else {
       
            linksDinamicosHTML = `
                <a href="${prefixoUrl}index.html" class="item-menu-lat"><i class="fa-solid fa-house"></i> Início</a>
                <a href="${prefixoUrl}ticket/ticket.html" class="item-menu-lat"><i class="fa-solid fa-folder-open"></i> Meus Tickets</a>
                <a href="${prefixoUrl}Estoque/estoque.html" class="item-menu-lat"><i class="fa-solid fa-car"></i> Ver Estoque</a>
            `;
        }
        ...
        <aside class="menu-lateral-painel" id="menuLateralPainel">
            <div class="topo-menu-lateral">
                ...
                <img src="${prefixoUrl}img/logovelox.png" alt="Logo Velox" class="logo-menu-lat">
            </div>
